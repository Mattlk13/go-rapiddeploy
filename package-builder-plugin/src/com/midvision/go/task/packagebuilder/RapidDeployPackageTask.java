...
@Extension
public class RapidDeployPackageTask extends AbstractGoPlugin {

	private static final Logger LOGGER = Logger.getLoggerFor(RapidDeployPackageTask.class);
	...
	private GoPluginApiResponse handleTaskView() {
		...
		view.put("displayValue", "RapidDeploy package builder");
		try {
	...
	private GoPluginApiResponse handleTaskExecution(GoPluginApiRequest request) {
		RapidDeployPackageTaskExecutor executor = new RapidDeployPackageTaskExecutor();
	...
	private GoPluginApiResponse handleGetConfigRequest() {
		...
		targetName.put("display-name", "Package name");
		targetName.put("required", false);
		config.put(PACKAGE_PROPERTY, targetName);
